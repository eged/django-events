...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'EventRelation', fields ['user', 'event']
        db.create_unique('events_eventrelation', ['user_id', 'event_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'EventRelation', fields ['user', 'event']
        db.delete_unique('events_eventrelation', ['user_id', 'event_id'])
    ...
    models = {
        ...
        'events.event': {
            'Meta': {'unique_together': "(('start', 'slug'),)", 'object_name': 'Event'},
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
        ...
        'events.eventrelation': {
            'Meta': {'unique_together': "(('user', 'event'),)", 'object_name': 'EventRelation'},
